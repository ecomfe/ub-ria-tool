...
define(
    function (require) {
         ...
         * 获取view数据的接口
         *
         * @method BaseChildView.getViewData
         * @return {Object}
         */
        ...
        exports.setViewData = function (values) {
            ...
            u.each(
                values,
                function (value, key) {
                    var controlId = u.dasherize(key);
                    this.get(controlId).set('rawValue', value);
                },
                this
            );
        };
         ...
         * disable当前View下所有控件
         *
         * @method BaseChildView.disableInputControls
         */
         ...
         * enable当前View下所有控件
         *
         * @method BaseChildView.enableInputControls
         */
         ...
         * 向用户通知提交错误信息
         *
         * @method BaseChildView.notifyErrors
         * @param {Object[]} errors 错误信息数组
         */
         ...
         *
         * @method BaseChildView.getAllInputControls
         * @return {Array} 所有InputControl控件
         */
        ...
        var BaseChildView = require('eoo').create(require('ef/UIView'), exports);
